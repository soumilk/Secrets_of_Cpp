// DIFFERENT WAYS IN WHICH A STRING IS ASSIGNED OR TAKEN AS AN INPUT IN A VARIABLE
...
int main()
{
    ...
    /*
       ...
       with this way we can only get the input of a single starting word but not a line.
    */
    string s3;
    cin>>s3;
    cout<<s3<<endl;

...
// LINEAR SINGLY LINKED LIST in C++ - FIND LARGEST ELEMENT IN LIST 
/*
...
/// THIS IS THE FUNCTION TO FIND THE LARGEST ELEMENT IN THE LIST 
...
int main()
{
    ...
    ll.Display();
    cout<<"The maximum element in list is ";
    cout<<ll.Find_max();
    return 0;
}
